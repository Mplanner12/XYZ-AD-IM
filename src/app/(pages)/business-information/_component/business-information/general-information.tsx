    ...
    <FormProvider {...methods}>
      ...
      >
        <div className="lg:w-[80%] w-full">
          ...
          <div className="mt-2 flex flex-col gap-y-1 2xl:gap-y-3">
            {/* Business name and description */}
            <div className="flex md:flex-row flex-col w-full gap-5 2xl:gap-8">
              <InputElement
                id="Company Name"
                label="Comapany Name"
                type="text"
          ...
          <div className="mt-5 flex w-full justify-between">
            <button
              ...
              disabled
              onClick={onPrev}
              className="rounded-xl hover:bg-white px-3 py-2 text-sm font-normal hover:text-foundation-grey-grey-900 shadow-sm border border-solid hover:border-foundation-grey-grey-600 bg-foundation-purple-purple-400 text-white disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
            >
              {isPending ? "" : "Prev"}
            </button>
            <button
