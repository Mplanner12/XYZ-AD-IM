...
const ModuleToggleList: React.FC<ModuleToggleListProps> = ({
  ...
  const [modules, setModules] = useState<ModuleItem[]>([
    {
      id: "accounting",
      title: "Accounting",
      description: "General ledger,payable & receivable",
      enabled: false,
    },
    {
      id: "inventory",
    ...
    },
    {
      id: "procurement",
      title: "Procurement",
      description: "Purchases & vendor management",
      enabled: false,
    },
    {
      id: "production",
      title: "Production",
      description: "Manufacturing flow & work orders",
      enabled: false,
    },
  ]);
  ...
  return (
    <div className="flex flex-col md:grid grid-cols-2 md:gap-2 gap-3 w-full">
      {modules.map((module) => (
        <div
          key={module.id}
          className="flex items-center justify-between py-3 px-1.5 bg-foundation-white-white-400 rounded-xl border border-foundation-grey-grey-300"
        >
          <div className="flex flex-col">
            <h3 className="text-foundation-black-black-400 text-[0.9rem] font-semibold">
              {module.title}
            </h3>
            <p className="text-foundation-grey-grey-700 text-[0.8rem] mt-1">
              {module.description}
            </p>
          </div>
          <div
