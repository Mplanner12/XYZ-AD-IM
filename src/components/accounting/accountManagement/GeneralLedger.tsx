        ...
        <div className="flex justify-between my-3">
          <div className="mb-3">
            <p className="text-xl font-medium mb-3">
              General Ledger Entries ({Object.keys(groupedEntries)?.length})
            </p>
            <div className="mb-4">
            ...
            <table className="min-w-[280%] md:min-w-[128%] lg:min-w-[130%] text-[14px]">
              <thead className="w-full">
                <tr className="text-[#374B58] text-[12px] border-[#eaecf0]  border-b  font-[500] bg-[#F5F5F5]">
                  ...
                  <td className="py-5 gap-2 items-center">List</td>
                  <td className="py-5 gap-2 items-center">Debit</td>
                  <td className="py-5 gap-2 items-center">Credit</td>
                  <td className="py-5 gap-2 pr-5 items-center">Balance</td>
                </tr>
              </thead>
              <tbody>
