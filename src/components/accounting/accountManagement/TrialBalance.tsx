    ...
    <>
              ...
              <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
                ...
                <tbody className="w-full bg-white">
                  <tr className=" border-[#eaecf0] hover:bg-gray-200 hover:bg-[#F2F8FF] text-[14px] border-b text-[#545A5D]">
                    ...
                    <td className="py-6  text-left ">Accounts Receivable</td>
                    <td className="py-6  text-left ">500</td>
                    <td className=" py-6 pr-5">1000</td>
                  </tr>
                  <tr className=" border-[#eaecf0] hover:bg-gray-200 hover:bg-[#F2F8FF] text-[14px] border-b text-[#545A5D]">
                    <td className="py-6 pl-5 text-left ">400101</td>
                    <td className="py-6  text-left ">Accounts Receivable</td>
                  ...
                  <tr className=" border-[#eaecf0] border-b hover:bg-gray-200 hover:bg-[#F2F8FF] text-[14px]  text-[#545A5D]">
      ...
      <div>
        {selectedTab === "Journal-details" && (
          <JournalDetails handleTabChange={handleTabChange} id="some-id" />
        )}
      </div>
    </>
  );
