import { useGetGeneralJournal } from "@/app/(pages)/accounting/hooks/query";
    ...
    <>
        ...
        <main>
          <div className="flex justify-between mt-3 mb-1">
            <p className="text-xl font-medium">
              Pending Journal Entries ({journals?.length})
            </p>
          ...
          <div className="text-[#8133F1] flex gap-5 items-center justify-between">
            ...
            <div className="flex gap-3">
              <button className="flex gap-1" onClick={handleViewAllDetails}>
                {" "}
                View all details{" "}
              </button>
              <button className="flex gap-1">
      ...
      <div>
        {selectedTab === "Journal-details" && (
          <JournalDetails
            id={selectedId}
            initialJournalsData={journalEntries}
