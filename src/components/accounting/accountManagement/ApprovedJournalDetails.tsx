import { useGetGeneralJournalById } from "@/app/(pages)/accounting/hooks/query";
...
const ApprovedJournalDetails: React.FC<JournalDetailsProps> = ({
  handleTabChange,
  id,
  journals,
}) => {
      ...
      <main className="pb-10">
        <div className="flex justify-between my-3">
          <p
            ...
            onClick={() => handleTabChange("approved-journal")}
          >
            ...
            <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px]">
              <thead className="w-full">
                <tr className="text-[#374B58] text-[12px] border-[#eaecf0]  border-b  font-[500] bg-[#F5F5F5]">
                  <td></td>
                  <td className="py-5 pl-5 gap-2 items-center">Date</td>
                  <td className="py-5 gap-2 items-center">Journal Type</td>
                  ...
                  ? journalDetails.entries.map((entry: any, index: number) => (
                      ...
                      >
                        ...
                        {index === 0 && (
                          ...
                          >
                            <TableDropDown
                              options={generateTableOptions(entry?.id)}
                            />
                          </td>
                        )}
                      </tr>
