...
import { useCreateAccountingList } from "@/app/(pages)/accounting/hooks/mutate";
...
const ListDetails = () => {
  ...
  const { data, isLoading, error } = useGetAccountingListById({
    id: accountId,
  });
  const lists = data || [];
  ...
  const [listFields, setListFields] = useState([
    ...
    { label: "Status", value: "Status", dataType: "Percentage", visible: true },
    {
      ...
      dataType: "Chart of Account List",
      visible: true,
    },
    {
      label: "Notes & Comment",
        ...
        <table className="w-full">
          <thead className="w-full">
            <tr className="text-[#374B58] text-[15px] font-[700]">
              <td className="py-5 pl-5  gap-2 items-center">Column Label</td>
