    ...
    return (
      <>
        <tr key={account._id} className="hover:bg-[#f7f7f7]">
          <td
            className="pl-5 py-2"
            style={{ paddingLeft: `${accountPadding}px` }}
          >
            {account.code}
          </td>
  ...
  const handleLogRowData = (rowData: any) => {
    ...
    openModal(
      <DeleteConfirmationModal
        TitleTopic="Are You sure you want to Delete this account"
        accountID={id}
      />
    );
  };
    ...
    return [
      {
        ...
        action: () =>
          handleNavigation(
            `/accounting/accounting-list/add-account/?id=${rowData.id}`
          ),
      },
      ...
      {isLoading ? (
        ...
        <main className="bg-secondary px-5 py-4 rounded-2xl text-[#434343]">
          <div className="flex justify-between my-3">
            <span className="text-[24px] flex items-center">
              Mushinware House <ChevronDownIcon className="ml-2" />
            </span>
            <div className="text-[15px]">
              ...
              <div className="text-[#8133F1] flex gap-2 justify-end">
                ...
                <button className="flex gap-1" onClick={handleOpenExportModal}>
                  Export Secondary Chart of Account{" "}
                  <Image
                    className="ml-2"
                    src="/export.png"
                    width={20}
          ...
          <div className="flex justify-between items-center my-5 text-[15px]">
            <p className="text-[20px]">
              Chart Of Account ({filteredAccounts.length})
            </p>
            ...
            <div>
              <Link href="/accounting/accounting-list/add-account">
                <span className="flex items-center text-[#8133F1]">
                  {" "}
                  <Image
                    className="mr-2"
                    src="/plus.png"
          ...
          <div className="text-[#8133F1] flex gap-5 justify-between text-[15px]">
            ...
            <button className="flex gap-1" onClick={handleOpenImportModal}>
              {" "}
              ...
              <table className="min-w-[280%] md:min-w-[128%] lg:min-w-full text-[14px] mb-5">
                <thead className="w-full">
                  <tr className="text-[#374B58] text-[12px] border-[#eaecf0]  border-b  font-[500] bg-[#F5F5F5]">
                    ...
                    <td className="py-5 gap-2 items-center">Acount Type</td>
                    <td className="py-5 gap-2 items-center">
                      Parent Account Type
                    </td>
                    <td className="py-5 gap-2 items-center">Location</td>
                    <td className="py-5 gap-2 items-center">Description</td>

                    <td className="py-5 gap-2 items-center">Opening Balance</td>
...
const COAFilterOptions = [
  ...
  },
  {
    ...
    subOptions: [{ label: "Active" }, { label: "Inactive" }],
  },
  {
    label: "Filter by Currency",
    subOptions: [{ label: "NGN" }, { label: "USD" }],
  },
  {
