  ...
  return (
    <div
      className={cn(
        ...
        "[@media(min-width:857px)]:relative w-[120px] [@media(min-width:1200px)]:w-[270px]  [@media(min-width:857px)]:translate-x-0",
    ...
    >
        ...
        {routes.map((route: any) => (
          ...
          >
            <Image
              ...
              width={18}
              height={18}
              className={cn("mr-2" , "[@media(max-width:1200px)]:mx-auto", "[@media(max-width:858px)]:mx-2")}
            />
            <p className={cn(
      ...
      <div className="mt-auto px-5 pb-4 pt-8">
        <ProfileDialogLayout userData={{ icon: dummyUser, name: "admin" }} open={open} setOpen={setOpen} />
      </div>
    </div>
  );
};
